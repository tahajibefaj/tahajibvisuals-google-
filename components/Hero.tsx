  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Noise overlay - Refined for Cinematic Detail */}
        {/* 
            Changes: 
            1. Adjusted baseFrequency to 0.65 (crisper, less blurry than 0.8).
            2. Increased numOctaves to 4 (adds micro-texture depth).
            3. Maintained 6% opacity and soft-light blend for premium subtlety.
        */}
        <div 
